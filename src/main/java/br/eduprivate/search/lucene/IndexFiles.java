...
/**
 * Index all text files under a directory. This is a command-line application
 * demonstrating simple Lucene indexing. Run it with no command-line arguments
...
public class IndexFiles {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// size to the JVM (eg add -Xmx5 or -Xmx:
			//
	...
	static void indexDoc(IndexWriter writer, Path file, long lastModified)
		...
		try (InputStream stream = Files.newInputStream(file)) {
			...
			// require.
			// For example the long value 20would mean
			// February 202-3 PM.
